  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <Image source={require('./imgs/cat.png') } style={{width: 300, height: 200}}/>
        <Image source={require('./imgs/cat.png') } style={{width: 300, height: 200}}/>
        <Image source={require('./imgs/cat.png') } style={{width: 300, height: 200}}/>
        <TextInput placeholder="What is your name" autoCorrect={false} onChangeText={text=> setName(text)} value={name}/>
